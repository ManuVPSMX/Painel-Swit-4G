...
function Editar(id){
				...
				$.post('ScriptModalMudarSenha.php', {id: id}, function(resposta) {
...
<!-- START X-NAVIGATION VERTICAL -->
                <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
					...
					echo "<li class=\"xn-icon-button\">
                        <span class=\"SpanIco\" style=\"width: 120px;\">Cota:&nbsp;&nbsp;".$Cota."</span>
                    </li>";
					...
					<li class="xn-icon-button pull-right last">
						...
						<?php echo "<li><a onclick=\"Editar('".$LnServer['id']."')\"><span class=\"fa fa-pencil\"></span> Alterar Dados</a></li>&nbsp;"; ?>
