...
function EnviarSMS($mensagem, $celular){
	...
	$url = "http://painel.kingsms.com.br/kingsms/api.php?acao=sendsms&login=".urlencode($usuario)."&token=".urlencode($senha)."&numero=".urlencode($celular)."&msg=".urlencode($mensagem)."";
