...
wget https://github.com/JeanRocha91x/Painel-Swit-4G/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/JeanRocha91x/Painel-Swit-4G/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/JeanRocha91x/Painel-Swit-4G/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/JeanRocha91x/Painel-Swit-4G/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/JeanRocha91x/Painel-Swit-4G/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
apt-get install php5 libapache2-mod-php5 php5-mysql -y > /dev/null 2>&1
apt-get install dirmngr apt-transport-https -y > /dev/null 2>&1
apt-get install php7.3-cli php7.3-fpm php7.3-json php7.3-pdo php7.3-zip php7.3-gd  php7.3-mbstring php7.3-curl php7.3-xml php7.3-bcmath php7.3-json -y > /dev/null 2>&1
...
apt-get install php7.3-mysql -y > /dev/null 2>&1
